...
my $ua = "Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; fr) Opera 11.00";
my $ua = "Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 5.1; ko) Opera 10.53";
my $ua = "Mozilla/4.0 (compatible; MSIE 6.0; X11; Linux i686; en) Opera 9.27";
my $method = "GET";
my $hilo;
